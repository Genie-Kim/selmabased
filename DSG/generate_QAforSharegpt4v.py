...
# with open('docci_meta_errorfix/question_overlooked_list.json','r') as f:
#     overlooked_list = json.load(f)
...
# overlooked_list = ['test_00966&3', 'test_01619&2', 'test_01640&7', 'test_01690&4', 'test_01992&6', 'test_02429&4', 'test_02695&12', 'test_02853&4', 'test_03568&4', 'test_03872&3', 'test_03935&3', 'test_04367&6', 'test_04503&7', 'test_04698&3', 'test_04815&7', 'test_04996&7']
# output_dict ={}
# for item in tqdm(overlooked_list):
#     example_id = item.split('&')[0]
#     sent_id = item.split('&')[1]
#     if 'dsg' in docci_id2meta[example_id]:
#         sent_info = docci_id2meta[example_id]['dsg']['question'][sent_id]
#         pprint(sent_info)
#         repeat=True
#         if len(sent_info['prompt'])<4:
#             print("!!!!!!!!!!error!!!!!!!!!!")
#             with open("docci_meta_errorfix/error_overlook.txt", "a") as f:
#                 f.write(f"{example_id}&{sent_id}\n")
#             continue
#         else:
#             while repeat:
#                 try:
#                     time.sleep(6)
#                     question_dict_list = text_to_question_dictlist(sent_info['prompt'])
#                     output_dict[item]=question_dict_list
#                     repeat=False
#                 except:
#                     print("!!!!!error occurred!!!!!")
#                     with open("docci_meta_errorfix/error_overlook.txt", "a") as f:
#                         f.write(f"{example_id}&{sent_id}\n")
# with open('docci_meta_errorfix/question_overlooked_fixed.json','w') as f:
