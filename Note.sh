...
# CUDA_VISIBLE_DEVICES=0,1,2 bash eval_docci_mPLUGL.sh "stabilityai/stable-diffusion-2-1" "clip_normal" 1


# tm01
# CUDA_VISIBLE_DEVICES=0 bash eval_docci_mPLUGL.sh "stabilityai/stable-diffusion-2-1" "clip_repeattext" 1

# tm02
tmux send-keys -t tm02 'CUDA_VISIBLE_DEVICES=1 bash eval_docci_mPLUGL.sh "stabilityai/stable-diffusion-2-1" "clip_summary" 1' ENTER
# tm03
tmux send-keys -t tm03 'CUDA_VISIBLE_DEVICES=2 bash eval_docci_mPLUGL.sh "stable-diffusion-v1-5" "clip_summary" 1' ENTER
# tm04
tmux send-keys -t tm04 'CUDA_VISIBLE_DEVICES=3 bash eval_docci_mPLUGL.sh "stable-diffusion-v1-5" "clip_repeattext" 1' ENTER



# tmux send-keys -t tm01 'CUDA_VISIBLE_DEVICES=0 bash eval_docci_mPLUGL.sh "stable-diffusion-v1-5" "clip_normal" 1' ENTER
# tmux send-keys -t tm02 'CUDA_VISIBLE_DEVICES=1 bash eval_docci_mPLUGL.sh "stable-diffusion-v1-5" "longclip" 1' ENTER
